    ...
    public class PersistedGrantStore : IPersistedGrantStore
    {
        ...
        public async Task StoreAsync(PersistedGrant token)
        {
            ...
            if (existing == null)
            {
                ...
                await _context.PersistedGrants.AddAsync(persistedGrant);
            }
            else
            {
        ...
        {
            var persistedGrants = await _context.PersistedGrants.AsNoTracking().Where(x => x.SubjectId == subjectId).ToListAsync();
